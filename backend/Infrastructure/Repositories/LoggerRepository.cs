...
namespace backend.Infrastructure.Repositories
{
    public class LoggerRepository : ILoggerRepository
    {
        ...
        public async Task<PaginatedResult<UserActionDTO>> GetAllLogsAsync(LoggerPaginationParameters parameters)
        {
            ...
            {
                query = query.Where(log => log.Operation == parameters.Operation.Value);
            }
